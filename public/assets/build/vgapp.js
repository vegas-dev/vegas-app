...
/* harmony import */ var _utils_js_components_templater__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../utils/js/components/templater */ "./app/utils/js/components/templater.js");
...
class VGFormSender extends _base_module__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  build() {
    ...
    if (this._params.pass.enabled) {
      let inputs = _utils_js_dom_selectors__WEBPACK_IMPORTED_MODULE_5__["default"].findAll('input[type="password"]', this._element);
      if (!inputs.length) return;
      new _utils_js_components_templater__WEBPACK_IMPORTED_MODULE_8__["default"](inputs, this._params.pass).render();
    }
...
let templates = [{
  ...
  type: 'pass',
  template: '<span data-vg-toggle="vgpass" title="Показать / Скрыть" data-bs-toggle="tooltip"><i class="fal fa-eye"></i></span>'
}];
class Templater {
  ...
  toHTML(content = '' | null, callback) {
    let tmpl = '';
    if (Array.isArray(this._element)) {} else {}
