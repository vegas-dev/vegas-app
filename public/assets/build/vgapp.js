    ...
    const completeCallback = () => {
      setTimeout(() => {
        ...
        if (_this._params.backdrop) {
          _utils_js_components_backdrop__WEBPACK_IMPORTED_MODULE_2__["default"].hide(function () {
            if (_this._params.overflow) {
              _utils_js_components_overflow__WEBPACK_IMPORTED_MODULE_3__["default"].destroy();
            }
          });
        }
        if (_this._params.overflow) {
      ...
      _utils_js_dom_event__WEBPACK_IMPORTED_MODULE_5__["default"].trigger(_this._element, EVENT_KEY_HIDDEN);
    };
...
class ScrollBarHelper {
  ...
  _applyManipulationCallback(selector, callBack) {
    ...
    for (const sel of _dom_selectors__WEBPACK_IMPORTED_MODULE_2__["default"].find(selector, this._element)) {
      callBack(sel);
    }
  }
}
