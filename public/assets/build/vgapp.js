...
class VGAlert extends _base_module__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  static run(message, element = null, params = {}, event = null) {
    ...
    const instance = VGAlert.getOrCreateInstance(element, (0,_utils_js_functions__WEBPACK_IMPORTED_MODULE_2__.mergeDeepObject)({
      message: message
    }, params));
