		...
		<div class="header-top">
			<div class="container">
				<div class="theme-area">
					<ul class="list" id="bd-theme">
						<li class="list-item">
							<a href="#" data-bs-theme-value="light" aria-pressed="false" class="">
						...
						<li class="list-item">
							<a href="#" data-bs-theme-value="dark" aria-pressed="true" class="active">
								<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M12 5C10.6155 5 9.26215 5.41054 8.11101 6.17971C6.95987 6.94888 6.06266 8.04213 5.53285 9.32121C5.00303 10.6003 4.86441 12.0078 5.13451 13.3656C5.4046 14.7235 6.07129 15.9708 7.05026 16.9497C8.02922 17.9287 9.2765 18.5954 10.6344 18.8655C11.9922 19.1356 13.3997 18.997 14.6788 18.4672C15.9579 17.9373 17.0511 17.0401 17.8203 15.889C18.5895 14.7378 19 13.3845 19 12C19 11.6422 18.9689 11.2844 18.9222 10.9422C18.5336 11.4872 18.0201 11.9311 17.4247 12.2369C16.8293 12.5428 16.1693 12.7015 15.5 12.7C14.6096 12.7 13.7422 12.4172 13.0229 11.8924C12.3037 11.3676 11.7697 10.6279 11.498 9.77992C11.2263 8.93198 11.231 8.01967 11.5113 7.17455C11.7916 6.32944 12.3332 5.59522 13.0578 5.07778C12.7156 5.03111 12.3578 5 12 5Z" fill="white"></path>
								</svg>
							</a>
						</li>
					</ul>
					...
					<div class="col-lg-3 col-10">
						<div class="logo-area">
							<a href="/">
								...
								<img src="/assets/images/logo/logo.svg" alt="Vegas" class="img-fluid light">
							</a>
						</div>
					</div>
					<div class="col-lg col-2">
						<nav class="vg-nav vg-nav-header" data-hover="true" data-breakpoint="false">
