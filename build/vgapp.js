...
class VGFormSender extends _base_module__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _alertModal(data, status) {
    ...
    let m = document.querySelector('.vg-modal'),
      id = _this._params.classes.general + '-' + (0,_utils_js_functions__WEBPACK_IMPORTED_MODULE_4__.makeRandomString)();
    ...
    function showModal(isBackDrop = true) {
      ...
      _vgmodal_js_vgmodal__WEBPACK_IMPORTED_MODULE_3__["default"].init(id, {
        ...
        if (isBackDrop) {
          setTimeout(() => {
            _utils_js_components_backdrop__WEBPACK_IMPORTED_MODULE_8__["default"].show();
          }, 50);
        }
      });
    }
