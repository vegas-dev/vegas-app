...
class VGNav extends _base_module__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  toggle() {
    ...
    if ('afterInit' in _this.params.callback) {
      (0,_utils_js_functions__WEBPACK_IMPORTED_MODULE_4__.execute)(_this.params.callback.afterInit, [_this]);
    }
    let $_a = [..._utils_js_selectors__WEBPACK_IMPORTED_MODULE_1__["default"].findAll('li > a', _this.navigation)];
    if (_this._isClickable()) {
      $_a.forEach(function (el) {
        _utils_js_event__WEBPACK_IMPORTED_MODULE_5__["default"].on(el, EVENT_CLICK_DATA_API, function (event) {
          let parent = event.currentTarget.closest('li');
          const relatedTarget = {
            relatedTarget: event.relatedTarget
          };
          if ('beforeClick' in _this.params.callback) {
            (0,_utils_js_functions__WEBPACK_IMPORTED_MODULE_4__.execute)(_this.params.callback.beforeClick, [_this, event]);
          }
          if (parent.classList.contains('dropdown') || parent.classList.contains('dropdown-mega')) {
            event.preventDefault();
            if (parent.classList.contains('dropdown-mega')) {
              let $drop = _utils_js_selectors__WEBPACK_IMPORTED_MODULE_1__["default"].findOne('.dropdown-mega-container', parent);
              ...
              const completeCallBack = () => {
                ...
                _utils_js_event__WEBPACK_IMPORTED_MODULE_5__["default"].trigger(this.element, EVENT_KEY_SHOWN, relatedTarget);
                if ('afterClick' in _this.params.callback) {
                  (0,_utils_js_functions__WEBPACK_IMPORTED_MODULE_4__.execute)(_this.params.callback.afterClick, [_this, event]);
                }
              };
  ...
  _isClickable() {
    if (!this.params.hover) {
      if (!_utils_js_responsive__WEBPACK_IMPORTED_MODULE_2__["default"].checkMobileOrTablet()) return true;
      return window.innerWidth <= _utils_js_responsive__WEBPACK_IMPORTED_MODULE_2__["default"].check(this);
    } else {
      return false;
    }
  }
  ...
  static hideOpenDrops(event) {
    let openToggles = [];
    openToggles.push(_utils_js_selectors__WEBPACK_IMPORTED_MODULE_1__["default"].findAll('.dropdown:not(.disabled):not(:disabled).active'));
    openToggles.push(_utils_js_selectors__WEBPACK_IMPORTED_MODULE_1__["default"].findAll('.dropdown-mega:not(.disabled):not(:disabled).active'));
