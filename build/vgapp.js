...
class VGDataTable extends _base_module__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _modeBuildTable(data) {
    let tbody = _utils_js_dom_selectors__WEBPACK_IMPORTED_MODULE_3__["default"].find('tbody', this._element),
      thead = _utils_js_dom_selectors__WEBPACK_IMPORTED_MODULE_3__["default"].find('thead', this._element);
    if (!thead && !tbody) return;
    let countTD = [..._utils_js_dom_selectors__WEBPACK_IMPORTED_MODULE_3__["default"].findAll('th', thead)].length;
    if (!countTD) return;
