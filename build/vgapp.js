...
/* harmony import */ var _sidebar_js_vgsidebar__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../sidebar/js/vgsidebar */ "./app/modules/sidebar/js/vgsidebar.js");
...
class VGNav extends _base_module__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _completeHide(relatedTarget) {
    ...
    if (relatedTarget.elm) {
      ...
      const showEvent = _utils_js_event__WEBPACK_IMPORTED_MODULE_5__["default"].trigger(parent, EVENT_KEY_HIDE, relatedTarget);
      if (showEvent.defaultPrevented) return;
      if (drop) {
        ...
        const completeCallback = () => {
          ...
          _utils_js_event__WEBPACK_IMPORTED_MODULE_5__["default"].trigger(parent, EVENT_KEY_HIDDEN, relatedTarget);
        };
...
_utils_js_event__WEBPACK_IMPORTED_MODULE_5__["default"].on(document, EVENT_CLICK_DATA_API, SELECTOR_DATA_TOGGLE, function (event) {
  ...
  [..._utils_js_selectors__WEBPACK_IMPORTED_MODULE_1__["default"].findAll('.active')].forEach(function (el) {
    if (el && el !== target) {
      instance.hide({
        relatedTarget: el
      });
