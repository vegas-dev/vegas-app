...
class VGNav extends _base_module__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  static init(element, params = {}) {
    ...
    if (instance.params.hover) {
      let currentElem = null;
      _utils_js_event__WEBPACK_IMPORTED_MODULE_5__["default"].on(instance._element, EVENT_MOUSEOVER_DATA_API, function (event) {
        if (currentElem) return;
      ...
      _utils_js_event__WEBPACK_IMPORTED_MODULE_5__["default"].on(instance._element, EVENT_MOUSEOUT_DATA_API, function (event) {
        if (!currentElem) return;
        let relatedTarget = event.relatedTarget;
        while (relatedTarget) {
          if (relatedTarget === currentElem) return;
