...
import {isEmptyObj} from "../_utils/js/functions";
...
class BaseModule extends Params{
	constructor(element, params) {
		...
		this.params = params;
		Data.set(this.element, this.constructor.NAME, this)
	}
	...
	static getInstance(element) {
		return Data.get(Manipulator.find(element), this.NAME)
	}

	dispose() {
		Data.remove(this.element, this.constructor.NAME)
